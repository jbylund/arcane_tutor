...
DB_COLUMNS = [
    ...
    FieldInfo(db_column_name="print_border", field_type=FieldType.TEXT, search_aliases=["border"], parser_class=ParserClass.TEXT, printing_level=PrintingLevel.PRINT, face_level=FaceLevel.FACE),
    FieldInfo(db_column_name="print_watermark", field_type=FieldType.TEXT, search_aliases=["watermark"], parser_class=ParserClass.TEXT, printing_level=PrintingLevel.PRINT, face_level=FaceLevel.FACE),
