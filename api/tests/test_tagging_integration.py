...
class TestTaggingIntegration:
    ...
    def test_discover_tags_from_scryfall_parses_response(self, mock_session_class) -> None:
    ...
    @patch("requests.Session")
    def test_fetch_tag_hierarchy_returns_none_when_no_parent(self, mock_session_class) -> None:
